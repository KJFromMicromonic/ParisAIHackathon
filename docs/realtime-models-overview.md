# Realtime Model Plugins Overview
...
To use a realtime model with a different TTS instance, configure the realtime model to use a text-only response modality and include a TTS instance in your AgentSession configuration.
...
- [Realtime Models Documentation](https://docs.livekit.io/agents/models/realtime/) - Main documentation page
- [Google Gemini Live API](https://docs.livekit.io/agents/models/realtime/plugins/gemini/) - Google Gemini integration
- [OpenAI Realtime API](https://docs.livekit.io/agents/models/realtime/plugins/openai/) - OpenAI integration
- [Azure OpenAI Realtime API](https://docs.livekit.io/agents/models/realtime/plugins/azure-openai/) - Azure OpenAI integration
